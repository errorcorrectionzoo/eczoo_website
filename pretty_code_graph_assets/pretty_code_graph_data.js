GENERATED_pretty_code_graph_data = {
    "elements": {
        "nodes": [
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 1,
                    "_description": [
                        "A code is a subset of a set or alphabet, with each element called a codeword. An error-correcting code consists of \\(K\\) codewords over an alphabet with \\(N\\) elements such that it is possible to r..."
                    ],
                    "_code_href": "/c/ecc",
            ...
            },
            {
                "data": {
                    ...
                    "label": "Lattice-based code",
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": [
                        "Encodes states (codewords) in coordinates of a lattice in the \\(n\\)-dimensional real coordinate space \\(\\mathbb{R}^n\\). The number of codewords may be infinite because the coordinate space is infin..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called Gabidulin or vector rank-metric code. The code corrects errors over rank metric instead of the traditional Hamming distance. The rank of an \\(n\\)-dimensional vector over \\(GF(q)^N\\) is ..."
                    ],
            ...
            },
            {
                "data": {
                    "id": "c_q-ary_linear",
                    "label": "Linear Galois-field \\(q\\)-ary code",
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": [
            ...
            },
            {
                "data": {
                    ...
                    "label": "Maximum-rank vector code",
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": [
            ...
            },
            {
                "data": {
                    ...
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": "Encodes \\(K\\) states (codewords) in an \\(m\\times n\\)-dimensional matrix of coordinates over the field \\(GF(q)\\).",
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 1,
                    "_description": [
                        "Encodes quantum information in a (logical) subspace of a (physical) Hilbert space such that it is possible to recover said information from errors that act as linear maps on the physical space. The..."
                    ],
                    "_code_href": "/c/qecc",
                    "_family_generation_level": 2
                },
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 1,
                    "_description": [
                        "A subsystem code, also known as an operator QECC, encodes information in a subsystem \\(\\mathsf{A}\\) of the code space \\(\\mathsf{C}\\), which is part of the system Hilbert space \\(\\mathsf{H}\\).\n\\begi..."
                    ],
                    "_code_href": "/c/oecc",
                    "_family_generation_level": 1
                },
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 1,
                    "_description": [
                        "Encodes quantum information in a \\(K\\)-dimensional (logical) subspace of an \\(N\\)-dimensional (physical) Hilbert space such that it is possible to recover said information from errors. The logical ..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Bosonic code whose codespace is defined as the common \\(+1\\) eigenspace of a group of mutually commuting displacement operators (exponentials of linear combinations of position and momentum operato..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called an oscillator or a continuous-variable (CV) code. Encodes logical Hilbert space, finite- or infinite-dimensional, into a physical Hilbert space that contains at least one oscillator (a...."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "An \\([[n,1]]_{\\mathbb{R}}\\) oscillator-into-oscillator CSS code<code:oscillator_stabilizer> defined using homological structres associated with an \\(n-1\\) simplex.\n\nStabilizer generators are define..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Bosonic rotation code consisting of superpositions of Pegg-Barnett phase states [10.1088/0305-4470/19/18/030],\n\\begin{align}\n|\\phi\\rangle \\equiv \\frac{1}{\\sqrt{2\\pi}}\\sum_{n=0}^{\\infty} \\mathrm{e}^..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "A family of abelian topological CSS stabilizer<code:css> codes defined on a \\(D\\)-dimensional lattice which satisfies two properties: The lattice is (1) a homogeneous simplicial \\(D\\)-complex obtai..."
                    ],
                    "_code_href": "/c/color",
                    "_family_generation_level": 5
                },
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "This is a family of codes derived via an algorithm that takes as input any binary classical code and outputs a quantum code (note that this framework can be extended to \\(q\\)-ary codes). The algori..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Floquet code inspired by the Kitaev honeycomb model [cond-mat/0506438] whose logical qubits are generated through a particular sequence of measurements.\n\nThe code is defined on a hexagonal (honeyco..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called a thermodynamic code [1902.07714]. An \\(n\\)-qubit approximate code whose codespace is formed by eigenstates of a translationally-invariant quantum many-body system which satisfies the E..."
                    ],
                    "_code_href": "/c/eth",
                    "_family_generation_level": 3
                },
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "An \\(((n,2^k,d))\\) qubit stabilizer code is denoted as \\([[n,k]]\\) or \\([[n,k,d]]\\), where \\(d\\) is the code's distance. Logical subspace is the joint \\(+1\\) eigenspace of a set of \\(2^{n-k}\\) comm..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Encodes \\(1\\) qubit into \\(n\\) qubits according to \\(|0\\rangle\\to|\\phi_0\\rangle^{\\otimes n}\\) and \\(|1\\rangle\\to|\\phi_1\\rangle^{\\otimes n}\\). Also known as a bit-flip code when \\(|\\phi_i\\rangle = |..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Hyperbolic surface code constructed using cellulation of a Riemann Manifold \\(M\\) exhibitng systolic freedom [10.2140/gtm.1999.2.113]. Codes derived from such manifolds can achieve distances scalin..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "A family of abelian topological CSS stabilizer<code:css> codes\nwhose generators are few-body \\(X\\)-type and \\(Z\\)-type Pauli strings\nassociated to the stars and plaquettes, respectively, of a cellu..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Nine-qubit CSS code<code:css> that is the smallest such code to correct a single-qubit error. The logical state is encoded using\n\\begin{align}\n\\begin{split}\n|\\overline{0}\\rangle&=\\frac{1}{2\\sqrt{2}..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called a gauge stabilizer code. A stabilizer code with some of its logical qubits denoted as gauge qubits and not used for storage of logical information. Note that this doesnt lead to new cod..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called quantum Reed-Solomon code. An \\([[n,k,n-k+1]]_{GF(q)}\\) (with \\(q>n\\)) Galois-qudit CSS code constructed using two Reed-Solomon codes over \\(GF(q)\\). Let \\(C_1\\) be a \\([n,k_1,d_1]_q\\) ..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called a \\(GF(q)\\)- or \\(\\mathbb{F}_q\\)-qudit code. Encodes \\(K\\)-dimensional Hilbert space into a \\(q^n\\)-dimensional (\\(n\\)-qudit) Hilbert space, with canonical qudit states \\(|k\\rangle\\) la..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Encodes a logical Hilbert space, finite- or infinite-dimensional, into a physical Hilbert space of \\(\\ell^2\\)-normalizable functions on a second-countable unimodular group. For \\(K\\)-dimensional lo..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "label": "\\([[2^r-1, 2^r-2r-1, 3]]_p\\) prime-qudit CSS code",
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": [
                        "A family of CSS codes extending Hamming-based CSS codes<code:quantum_hamming_css> to prime qudits of dimension \\(p\\) by expressing the qubit code stabilizers in local-dimension-invariant (LDI) form..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called a \\(\\mathbb{Z}_q\\)-qudit code. Encodes \\(K\\)-dimensional Hilbert space into a \\(q^n\\)-dimensional (\\(n\\)-qudit) Hilbert space, with canonical qudit states \\(|k\\rangle\\) labeled by eleme..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called quantum Reed-Solomon code. An \\([[n,k,n-k+1]]_p\\) (with prime \\(p>n\\)) prime-qudit CSS code constructed using two Reed-Solomon codes over \\(GF(p)=\\mathbb{Z}_p\\). Let \\(\\{\\alpha_1,\\cdots..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Fusion Based Quantum Computing, or FBQC, describes a fault tolerant way to produce fusion networks, or large entangled states starting from small constant-sized entangled resource states along with..."
                    ],
                    "_code_href": "/c/fusion",
                    "_family_generation_level": 7
                },
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 1,
                    "_description": [
                        "Stabilizer code formulated using the CSS chain-complex<code:css> construction, with chain complexes consisting of products of other chain complexes. The chain-complex construction of codes yields a..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Family of \\(G\\)-lifted product codes constructed using two random classical Tanner codes<code:tanner> defined on expander graphs. For certain parameters, this construction yields the first asymptot..."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "CSS stabilizer code constructed from a CSS code and a classical code using a distance-balancing procedure based on a generalized homological product. The initial code is said to be unbalanced, i.e...."
                    ],
            ...
            },
            {
                "data": {
                    ...
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": "CSS code formulated using the CSS chain-complex<code:css> construction in the homological product construction. Stub.\n",
            ...
            },
            {
                "data": {
                    ...
                    "_is_abstract_code": 0,
                    "_description": [
                        "Encodes a finite-dimensional logical Hilbert space into a physical Hilbert space associated with a category. Often associated with a particular topological quantum field theory (TQFT), as the data ..."
                    ],
            ...
            },
            {
                "data": {
                    "id": "c_string_net",
                    "label": "String-net code",
                    "_is_code": 1,
                    "_is_abstract_code": 0,
                    "_description": [
                        "Also called a Turaev-Viro or Levin-Wen model code. A family of topological codes, defined by a finite unitary spherical category \\( \\mathcal{C} \\),  whose generators are few-body operators acting o..."
                    ],
        ...
        "edges": [
            ...
            {
                "data": {
                    "id": "cousin_points_into_lattices_binary_linear__0",
                    "_rel_type": "cousin",
                    "source": "c_points_into_lattices",
            ...
            {
                "data": {
                    "id": "parent_binary_linear_bits_into_bits_3",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_polar_binary_linear_5",
                    "_rel_type": "parent",
                    "source": "c_polar",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_polar_reed_muller__4",
                    "_rel_type": "cousin",
                    "source": "c_polar",
            ...
            {
                "data": {
                    "id": "cousin_polar_generalized_concatenated__5",
                    "_rel_type": "cousin",
                    "source": "c_polar",
            ...
            {
                "data": {
                    "id": "kingdomtodomain_bits_into_bits_classical_domain_2",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_bits_into_bits_ecc_6",
                    "_rel_type": "parent",
                    "source": "c_bits_into_bits",
                    "target": "c_ecc"
                }
            ...
            {
                "data": {
                    "id": "parent_reed_muller_binary_linear_8",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_hamming_binary_linear_9",
                    "_rel_type": "parent",
                    "source": "c_hamming",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_hamming_quantum_hamming__7",
                    "_rel_type": "cousin",
                    "source": "c_hamming",
            ...
            {
                "data": {
                    "id": "parent_hadamard_binary_linear_10",
                    "_rel_type": "parent",
                    "source": "c_hadamard",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_hadamard_reed_muller__10",
                    "_rel_type": "cousin",
                    "source": "c_hadamard",
                    "target": "c_reed_muller"
                }
            ...
            {
                "data": {
                    "id": "parent_repetition_hamming_12",
                    "_rel_type": "parent",
                    "source": "c_repetition",
                    "target": "c_hamming"
                }
            ...
            {
                "data": {
                    "id": "cousin_repetition_quantum_repetition__11",
                    "_rel_type": "cousin",
                    "source": "c_repetition",
            ...
            {
                "data": {
                    "id": "parent_parity_check_binary_linear_13",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_single_parity_check_parity_check_14",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_homological_classical_binary_linear_15",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_homological_classical_perfect__13",
                    "_rel_type": "cousin",
                    "source": "c_homological_classical",
                    "target": "c_perfect"
                }
            ...
            {
                "data": {
                    "id": "cousin_homological_classical_css__14",
                    "_rel_type": "cousin",
                    "source": "c_homological_classical",
                    "target": "c_css"
                }
            ...
            {
                "data": {
                    "id": "parent_ldpc_parity_check_16",
                    "_rel_type": "parent",
                    "source": "c_ldpc",
                    "target": "c_parity_check"
                }
            ...
            {
                "data": {
                    "id": "cousin_convolutional_quantum_convolutional__15",
                    "_rel_type": "cousin",
                    "source": "c_convolutional",
            ...
            {
                "data": {
                    "id": "cousin_convolutional_reed_solomon__16",
                    "_rel_type": "cousin",
                    "source": "c_convolutional",
                    "target": "c_reed_solomon"
                }
            ...
            {
                "data": {
                    "id": "parent_alternant_q-ary_linear_18",
                    "_rel_type": "parent",
                    "source": "c_alternant",
            ...
            {
                "data": {
                    "id": "parent_generalized_concatenated_ecc_19",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "kingdomtodomain_rings_into_rings_classical_domain_3",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_rings_into_rings_ecc_21",
                    "_rel_type": "parent",
                    "source": "c_rings_into_rings",
                    "target": "c_ecc"
                }
            ...
            {
                "data": {
                    "id": "parent_reed_solomon_generalized_reed_solomon_22",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_reed_solomon_hamming__17",
                    "_rel_type": "cousin",
                    "source": "c_reed_solomon",
                    "target": "c_hamming"
                }
            ...
            {
                "data": {
                    "id": "cousin_reed_solomon_mds__18",
                    "_rel_type": "cousin",
                    "source": "c_reed_solomon",
                    "target": "c_mds"
                }
            ...
            {
                "data": {
                    "id": "cousin_reed_solomon_cyclic__19",
                    "_rel_type": "cousin",
                    "source": "c_reed_solomon",
                    "target": "c_cyclic"
                }
            ...
            {
                "data": {
                    "id": "parent_q-ary_digits_into_q-ary_digits_ecc_23",
                    "_rel_type": "parent",
                    "source": "c_q-ary_digits_into_q-ary_digits",
                    "target": "c_ecc"
                }
            ...
            {
                "data": {
                    "id": "parent_dual_q-ary_linear_24",
                    "_rel_type": "parent",
                    "source": "c_dual",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_gabidulin_q-ary_digits_into_q-ary_digits_25",
                    "_rel_type": "parent",
                    "source": "c_gabidulin",
            ...
            {
                "data": {
                    "id": "parent_q-ary_linear_q-ary_digits_into_q-ary_digits_27",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_cyclic_skew_cyclic_28",
                    "_rel_type": "parent",
                    "source": "c_cyclic",
            ...
            {
                "data": {
                    "id": "parent_quasi_cyclic_q-ary_linear_30",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_skew_cyclic_quasi_cyclic_31",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_group_q-ary_linear_32",
                    "_rel_type": "parent",
                    "source": "c_group",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_reed_muller__22",
                    "_rel_type": "cousin",
                    "source": "c_group",
                    "target": "c_reed_muller"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_group_quantum__23",
                    "_rel_type": "cousin",
                    "source": "c_group",
            ...
            {
                "data": {
                    "id": "parent_generalized_reed_solomon_alternant_33",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_generalized_reed_solomon_goppa__24",
                    "_rel_type": "cousin",
                    "source": "c_generalized_reed_solomon",
                    "target": "c_goppa"
                }
            ...
            {
                "data": {
                    "id": "cousin_generalized_reed_solomon_bch__25",
                    "_rel_type": "cousin",
                    "source": "c_generalized_reed_solomon",
                    "target": "c_bch"
                }
            ...
            {
                "data": {
                    "id": "parent_maximum_rank_distance_gabidulin_34",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "kingdomtodomain_matrices_into_matrices_classical_domain_5",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_matrices_into_matrices_ecc_35",
                    "_rel_type": "parent",
                    "source": "c_matrices_into_matrices",
                    "target": "c_ecc"
                }
            ...
            {
                "data": {
                    "id": "parent_gkp_qudits_into_oscillators_39",
                    "_rel_type": "parent",
                    "source": "c_gkp",
            ...
            {
                "data": {
                    "id": "parent_gkp_oscillator_stabilizer_40",
                    "_rel_type": "parent",
                    "source": "c_gkp",
            ...
            {
                "data": {
                    "id": "cousin_gkp_approximate_qecc__27",
                    "_rel_type": "cousin",
                    "source": "c_gkp",
            ...
            {
                "data": {
                    "id": "parent_niset_andersen_cerf_oscillators_into_oscillators_41",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_oscillator_stabilizer_oscillators_42",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_oscillator_stabilizer_stabilizer__28",
                    "_rel_type": "cousin",
                    "source": "c_oscillator_stabilizer",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "kingdomtodomain_oscillators_quantum_domain_6",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_qudits_into_oscillators_oscillators_44",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_homological_cv_oscillators_into_oscillators_45",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_homological_cv_oscillator_stabilizer_46",
                    "_rel_type": "parent",
                    "source": "c_homological_cv",
                    "target": "c_oscillator_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_homological_cv_css__29",
                    "_rel_type": "cousin",
                    "source": "c_homological_cv",
                    "target": "c_css"
                }
            ...
            {
                "data": {
                    "id": "cousin_homological_cv_niset_andersen_cerf__30",
                    "_rel_type": "cousin",
                    "source": "c_homological_cv",
            ...
            {
                "data": {
                    "id": "parent_oscillators_into_oscillators_oscillators_47",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_hybrid_qudit_oscillator_oscillators_48",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_hybrid_qudit_oscillator_qudits_into_oscillators__31",
                    "_rel_type": "cousin",
                    "source": "c_hybrid_qudit_oscillator",
                    "target": "c_qudits_into_oscillators"
                }
            ...
            {
                "data": {
                    "id": "parent_very-small-logical-qubit_hybrid_qudit_oscillator_49",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_very-small-logical-qubit_quantum_repetition__32",
                    "_rel_type": "cousin",
                    "source": "c_very-small-logical-qubit",
                    "target": "c_quantum_repetition"
                }
            ...
            {
                "data": {
                    "id": "parent_binomial_bosonic_rotation_50",
                    "_rel_type": "parent",
                    "source": "c_binomial",
            ...
            {
                "data": {
                    "id": "cousin_binomial_number_phase__34",
                    "_rel_type": "cousin",
                    "source": "c_binomial",
            ...
            {
                "data": {
                    "id": "parent_dual_rail_fock_state_51",
                    "_rel_type": "parent",
                    "source": "c_dual_rail",
                    "target": "c_fock_state"
                }
            ...
            {
                "data": {
                    "id": "parent_fock_state_qudits_into_oscillators_52",
                    "_rel_type": "parent",
                    "source": "c_fock_state",
                    "target": "c_qudits_into_oscillators"
                }
            ...
            {
                "data": {
                    "id": "cousin_fock_state_binary_linear__35",
                    "_rel_type": "cousin",
                    "source": "c_fock_state",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_fock_state_qubits_into_qubits__36",
                    "_rel_type": "cousin",
                    "source": "c_fock_state",
            ...
            {
                "data": {
                    "id": "parent_cat_bosonic_rotation_53",
                    "_rel_type": "parent",
                    "source": "c_cat",
                    "target": "c_bosonic_rotation"
                }
            ...
            {
                "data": {
                    "id": "cousin_cat_number_phase__37",
                    "_rel_type": "cousin",
                    "source": "c_cat",
                    "target": "c_number_phase"
                }
            ...
            {
                "data": {
                    "id": "parent_bosonic_rotation_fock_state_54",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_bosonic_rotation_gkp__39",
                    "_rel_type": "cousin",
                    "source": "c_bosonic_rotation",
                    "target": "c_gkp"
                }
            ...
            {
                "data": {
                    "id": "parent_number_phase_bosonic_rotation_55",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_number_phase_rotor_gkp__40",
                    "_rel_type": "cousin",
                    "source": "c_number_phase",
                    "target": "c_rotor_gkp"
                }
            ...
            {
                "data": {
                    "id": "parent_wasilewski-banaszek_fock_state_56",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_wasilewski-banaszek_chuang-leung-yamamoto__41",
                    "_rel_type": "cousin",
                    "source": "c_wasilewski-banaszek",
            ...
            {
                "data": {
                    "id": "parent_chuang-leung-yamamoto_fock_state_57",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_quantum_polar_css_58",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_polar_polar__42",
                    "_rel_type": "cousin",
                    "source": "c_quantum_polar",
                    "target": "c_polar"
                }
            ...
            {
                "data": {
                    "id": "parent_monitored_random_circuits_random_circuit_59",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_monitored_random_circuits_topological__43",
                    "_rel_type": "cousin",
                    "source": "c_monitored_random_circuits",
            ...
            {
                "data": {
                    "id": "cousin_css_binary_linear__44",
                    "_rel_type": "cousin",
                    "source": "c_css",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_haah_cubic_stabilizer_62",
                    "_rel_type": "parent",
                    "source": "c_haah_cubic",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_haah_cubic_fracton_63",
                    "_rel_type": "parent",
                    "source": "c_haah_cubic",
                    "target": "c_fracton"
                }
            ...
            {
                "data": {
                    "id": "cousin_haah_cubic_color__46",
                    "_rel_type": "cousin",
                    "source": "c_haah_cubic",
                    "target": "c_color"
                }
            ...
            {
                "data": {
                    "id": "cousin_haah_cubic_surface__47",
                    "_rel_type": "cousin",
                    "source": "c_haah_cubic",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_convolutional_stabilizer_64",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_xyz_hexagonal_matching_65",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_quantum_parity_css_66",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_quantum_parity_quantum_concatenated_67",
                    "_rel_type": "parent",
                    "source": "c_quantum_parity",
            ...
            {
                "data": {
                    "id": "cousin_quantum_parity_quantum_repetition__48",
                    "_rel_type": "cousin",
                    "source": "c_quantum_parity",
                    "target": "c_quantum_repetition"
                }
            ...
            {
                "data": {
                    "id": "cousin_quantum_parity_bacon_shor__49",
                    "_rel_type": "cousin",
                    "source": "c_quantum_parity",
                    "target": "c_bacon_shor"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_hamming_stabilizer_68",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_hamming_quantum_perfect__50",
                    "_rel_type": "cousin",
                    "source": "c_quantum_hamming",
            ...
            {
                "data": {
                    "id": "parent_color_topological_abelian_70",
                    "_rel_type": "parent",
                    "source": "c_color",
            ...
            {
                "data": {
                    "id": "parent_quantum_hamming_css_css_71",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_hamming_css_hamming__52",
                    "_rel_type": "cousin",
                    "source": "c_quantum_hamming_css",
                    "target": "c_hamming"
                }
            ...
            {
                "data": {
                    "id": "parent_matching_stabilizer_72",
                    "_rel_type": "parent",
                    "source": "c_matching",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_matching_topological_abelian_73",
                    "_rel_type": "parent",
                    "source": "c_matching",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "parent_permutation_invariant_qubits_into_qubits_74",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_permutation_invariant_quantum_cyclic__53",
                    "_rel_type": "cousin",
                    "source": "c_permutation_invariant",
            ...
            {
                "data": {
                    "id": "parent_gnu_permutation_invariant_permutation_invariant_75",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_gnu_permutation_invariant_bacon_shor__54",
                    "_rel_type": "cousin",
                    "source": "c_gnu_permutation_invariant",
                    "target": "c_bacon_shor"
                }
            ...
            {
                "data": {
                    "id": "cousin_gnu_permutation_invariant_hamiltonian__55",
                    "_rel_type": "cousin",
                    "source": "c_gnu_permutation_invariant",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "cousin_gnu_permutation_invariant_approximate_qecc__56",
                    "_rel_type": "cousin",
                    "source": "c_gnu_permutation_invariant",
                    "target": "c_approximate_qecc"
                }
            ...
            {
                "data": {
                    "id": "cousin_gnu_permutation_invariant_binomial__57",
                    "_rel_type": "cousin",
                    "source": "c_gnu_permutation_invariant",
                    "target": "c_binomial"
                }
            ...
            {
                "data": {
                    "id": "parent_movassagh_ouyang_qubits_into_qubits_76",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_movassagh_ouyang_hamiltonian_77",
                    "_rel_type": "parent",
                    "source": "c_movassagh_ouyang",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "cousin_movassagh_ouyang_stabilizer__58",
                    "_rel_type": "cousin",
                    "source": "c_movassagh_ouyang",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_movassagh_ouyang_bits_into_bits__59",
                    "_rel_type": "cousin",
                    "source": "c_movassagh_ouyang",
                    "target": "c_bits_into_bits"
                }
            ...
            {
                "data": {
                    "id": "parent_stabilizer_over_gf4_stabilizer_78",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_stabilizer_over_gf4_q-ary_linear__60",
                    "_rel_type": "cousin",
                    "source": "c_stabilizer_over_gf4",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_cws_qubits_into_qubits_79",
                    "_rel_type": "parent",
                    "source": "c_cws",
                    "target": "c_qubits_into_qubits"
                }
            ...
            {
                "data": {
                    "id": "cousin_cws_movassagh_ouyang__61",
                    "_rel_type": "cousin",
                    "source": "c_cws",
                    "target": "c_movassagh_ouyang"
                }
            ...
            {
                "data": {
                    "id": "parent_honeycomb_floquet_80",
                    "_rel_type": "parent",
                    "source": "c_honeycomb",
                    "target": "c_floquet"
                }
            ...
            {
                "data": {
                    "id": "cousin_honeycomb_surface__62",
                    "_rel_type": "cousin",
                    "source": "c_honeycomb",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "cousin_honeycomb_subsystem_color__63",
                    "_rel_type": "cousin",
                    "source": "c_honeycomb",
            ...
            {
                "data": {
                    "id": "cousin_honeycomb_majorana_stab__64",
                    "_rel_type": "cousin",
                    "source": "c_honeycomb",
            ...
            {
                "data": {
                    "id": "cousin_honeycomb_matching__65",
                    "_rel_type": "cousin",
                    "source": "c_honeycomb",
                    "target": "c_matching"
                }
            ...
            {
                "data": {
                    "id": "parent_eth_approximate_qecc_82",
                    "_rel_type": "parent",
                    "source": "c_eth",
                    "target": "c_approximate_qecc"
                }
            ...
            {
                "data": {
                    "id": "parent_haar_random_random_circuit_83",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_haar_random_t-designs__68",
                    "_rel_type": "cousin",
                    "source": "c_haar_random",
                    "target": "c_t-designs"
                }
            ...
            {
                "data": {
                    "id": "cousin_stabilizer_binary_linear__69",
                    "_rel_type": "cousin",
                    "source": "c_stabilizer",
                    "target": "c_binary_linear"
                }
            ...
            {
                "data": {
                    "id": "cousin_stabilizer_hamiltonian__70",
                    "_rel_type": "cousin",
                    "source": "c_stabilizer",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "cousin_stabilizer_qudit_stabilizer__71",
                    "_rel_type": "cousin",
                    "source": "c_stabilizer",
            ...
            {
                "data": {
                    "id": "parent_quantum_triorthogonal_css_85",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_double_semion_qudit_stabilizer_86",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_double_semion_topological_abelian_87",
                    "_rel_type": "parent",
                    "source": "c_double_semion",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "cousin_double_semion_surface__73",
                    "_rel_type": "cousin",
                    "source": "c_double_semion",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_repetition_css_88",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_repetition_hamiltonian__74",
                    "_rel_type": "cousin",
                    "source": "c_quantum_repetition",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "parent_happy_holographic_89",
                    "_rel_type": "parent",
                    "source": "c_happy",
            ...
            {
                "data": {
                    "id": "cousin_happy_stab_5_1_3__75",
                    "_rel_type": "cousin",
                    "source": "c_happy",
                    "target": "c_stab_5_1_3"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_reed_muller_css_91",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_reed_muller_reed_muller__76",
                    "_rel_type": "cousin",
                    "source": "c_quantum_reed_muller",
                    "target": "c_reed_muller"
                }
            ...
            {
                "data": {
                    "id": "cousin_quantum_reed_muller_quantum_convolutional__77",
                    "_rel_type": "cousin",
                    "source": "c_quantum_reed_muller",
                    "target": "c_quantum_convolutional"
                }
            ...
            {
                "data": {
                    "id": "parent_floquet_dynamic_gen_92",
                    "_rel_type": "parent",
                    "source": "c_floquet",
            ...
            {
                "data": {
                    "id": "parent_floquet_stabilizer_93",
                    "_rel_type": "parent",
                    "source": "c_floquet",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_floquet_subsystem_stabilizer__78",
                    "_rel_type": "cousin",
                    "source": "c_floquet",
            ...
            {
                "data": {
                    "id": "cousin_floquet_monitored_random_circuits__79",
                    "_rel_type": "cousin",
                    "source": "c_floquet",
            ...
            {
                "data": {
                    "id": "parent_t-designs_random_circuit_94",
                    "_rel_type": "parent",
                    "source": "c_t-designs",
                    "target": "c_random_circuit"
                }
            ...
            {
                "data": {
                    "id": "cousin_t-designs_topological__80",
                    "_rel_type": "cousin",
                    "source": "c_t-designs",
                    "target": "c_topological"
                }
            ...
            {
                "data": {
                    "id": "cousin_t-designs_approximate_qecc__81",
                    "_rel_type": "cousin",
                    "source": "c_t-designs",
                    "target": "c_approximate_qecc"
                }
            ...
            {
                "data": {
                    "id": "parent_nonlocal_lowdepth_random_circuit_95",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_qubits_into_qubits_qecc_finite_96",
                    "_rel_type": "parent",
                    "source": "c_qubits_into_qubits",
            ...
            {
                "data": {
                    "id": "parent_real_projective_plane_surface_97",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_xzzx_clifford-deformed_surface_98",
                    "_rel_type": "parent",
                    "source": "c_xzzx",
            ...
            {
                "data": {
                    "id": "cousin_xzzx_topological_abelian__83",
                    "_rel_type": "cousin",
                    "source": "c_xzzx",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "parent_hyperbolic_surface_surface_99",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_hyperbolic_surface_holographic__84",
                    "_rel_type": "cousin",
                    "source": "c_hyperbolic_surface",
                    "target": "c_holographic"
                }
            ...
            {
                "data": {
                    "id": "parent_fractal_surface_surface_100",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_fractal_surface_higher_dimensional_surface__85",
                    "_rel_type": "cousin",
                    "source": "c_fractal_surface",
            ...
            {
                "data": {
                    "id": "parent_freedman_meyer_luo_hyperbolic_surface_101",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_xysurface_clifford-deformed_surface_102",
                    "_rel_type": "parent",
                    "source": "c_xysurface",
                    "target": "c_clifford-deformed_surface"
                }
            ...
            {
                "data": {
                    "id": "parent_higher_dimensional_surface_surface_103",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_four_dimensional_hyperbolic_hyperbolic_surface_104",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_two_dimensional_hyperbolic_surface_hyperbolic_surface_105",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_surface_clifford-deformed_surface_107",
                    "_rel_type": "parent",
                    "source": "c_surface",
                    "target": "c_clifford-deformed_surface"
                }
            ...
            {
                "data": {
                    "id": "cousin_surface_topological_abelian__86",
                    "_rel_type": "cousin",
                    "source": "c_surface",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "cousin_surface_hypergraph_product__87",
                    "_rel_type": "cousin",
                    "source": "c_surface",
            ...
            {
                "data": {
                    "id": "cousin_surface_stabilizer__88",
                    "_rel_type": "cousin",
                    "source": "c_surface",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_clifford-deformed_surface_stabilizer_108",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_clifford-deformed_surface_topological_abelian_109",
                    "_rel_type": "parent",
                    "source": "c_clifford-deformed_surface",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "cousin_clifford-deformed_surface_dynamic_gen__89",
                    "_rel_type": "cousin",
                    "source": "c_clifford-deformed_surface",
                    "target": "c_dynamic_gen"
                }
            ...
            {
                "data": {
                    "id": "parent_steane_quantum_hamming_css_110",
                    "_rel_type": "parent",
                    "source": "c_steane",
            ...
            {
                "data": {
                    "id": "parent_stab_5_1_3_stabilizer_over_gf4_112",
                    "_rel_type": "parent",
                    "source": "c_stab_5_1_3",
            ...
            {
                "data": {
                    "id": "cousin_stab_5_1_3_quantum_perfect__91",
                    "_rel_type": "cousin",
                    "source": "c_stab_5_1_3",
                    "target": "c_quantum_perfect"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_5_1_3_quantum_mds__92",
                    "_rel_type": "cousin",
                    "source": "c_stab_5_1_3",
            ...
            {
                "data": {
                    "id": "cousin_stab_5_1_3_quantum_cyclic__93",
                    "_rel_type": "cousin",
                    "source": "c_stab_5_1_3",
                    "target": "c_quantum_cyclic"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_5_1_3_hamiltonian__94",
                    "_rel_type": "cousin",
                    "source": "c_stab_5_1_3",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_5_1_3_majorana_stab__95",
                    "_rel_type": "cousin",
                    "source": "c_stab_5_1_3",
                    "target": "c_majorana_stab"
                }
            ...
            {
                "data": {
                    "id": "parent_shor_nine_quantum_parity_113",
                    "_rel_type": "parent",
                    "source": "c_shor_nine",
            ...
            {
                "data": {
                    "id": "cousin_shor_nine_quantum_repetition__96",
                    "_rel_type": "cousin",
                    "source": "c_shor_nine",
                    "target": "c_quantum_repetition"
                }
            ...
            {
                "data": {
                    "id": "cousin_shor_nine_quantum_concatenated__97",
                    "_rel_type": "cousin",
                    "source": "c_shor_nine",
                    "target": "c_quantum_concatenated"
                }
            ...
            {
                "data": {
                    "id": "cousin_shor_nine_real_projective_plane__98",
                    "_rel_type": "cousin",
                    "source": "c_shor_nine",
            ...
            {
                "data": {
                    "id": "parent_stab_15_1_3_quantum_reed_muller_114",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_stab_15_1_3_quantum_triorthogonal_115",
                    "_rel_type": "parent",
                    "source": "c_stab_15_1_3",
            ...
            {
                "data": {
                    "id": "cousin_stab_15_1_3_color__99",
                    "_rel_type": "cousin",
                    "source": "c_stab_15_1_3",
                    "target": "c_color"
                }
            ...
            {
                "data": {
                    "id": "parent_stab_4_2_2_quantum_parity_116",
                    "_rel_type": "parent",
                    "source": "c_stab_4_2_2",
                    "target": "c_quantum_parity"
                }
            ...
            {
                "data": {
                    "id": "parent_stab_4_2_2_surface_117",
                    "_rel_type": "parent",
                    "source": "c_stab_4_2_2",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_4_2_2_stab_5_1_3__100",
                    "_rel_type": "cousin",
                    "source": "c_stab_4_2_2",
                    "target": "c_stab_5_1_3"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_4_2_2_quantum_polar__101",
                    "_rel_type": "cousin",
                    "source": "c_stab_4_2_2",
            ...
            {
                "data": {
                    "id": "cousin_stab_4_2_2_approximate_qecc__102",
                    "_rel_type": "cousin",
                    "source": "c_stab_4_2_2",
                    "target": "c_approximate_qecc"
                }
            ...
            {
                "data": {
                    "id": "parent_subsystem_stabilizer_oecc_118",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_subsystem_stabilizer_stabilizer__103",
                    "_rel_type": "cousin",
                    "source": "c_subsystem_stabilizer",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_bacon_shor_bravyi_bacon_shor_119",
                    "_rel_type": "parent",
                    "source": "c_bacon_shor",
            ...
            {
                "data": {
                    "id": "parent_bravyi_bacon_shor_subsystem_stabilizer_120",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_subsystem_color_subsystem_stabilizer_121",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_subsystem_color_color__104",
                    "_rel_type": "cousin",
                    "source": "c_subsystem_color",
                    "target": "c_color"
                }
            ...
            {
                "data": {
                    "id": "parent_binary_quantum_goppa_galois_css_122",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_binary_quantum_goppa_goppa__105",
                    "_rel_type": "cousin",
                    "source": "c_binary_quantum_goppa",
                    "target": "c_goppa"
                }
            ...
            {
                "data": {
                    "id": "parent_galois_polynomial_galois_css_123",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_galois_polynomial_polynomial__106",
                    "_rel_type": "cousin",
                    "source": "c_galois_polynomial",
                    "target": "c_polynomial"
                }
            ...
            {
                "data": {
                    "id": "cousin_galois_polynomial_reed_solomon__107",
                    "_rel_type": "cousin",
                    "source": "c_galois_polynomial",
                    "target": "c_reed_solomon"
                }
            ...
            {
                "data": {
                    "id": "cousin_galois_polynomial_cyclic__108",
                    "_rel_type": "cousin",
                    "source": "c_galois_polynomial",
                    "target": "c_cyclic"
                }
            ...
            {
                "data": {
                    "id": "cousin_galois_polynomial_quantum_mds__109",
                    "_rel_type": "cousin",
                    "source": "c_galois_polynomial",
                    "target": "c_quantum_mds"
                }
            ...
            {
                "data": {
                    "id": "parent_galois_css_galois_true_stabilizer_124",
                    "_rel_type": "parent",
                    "source": "c_galois_css",
            ...
            {
                "data": {
                    "id": "cousin_galois_css_q-ary_linear__111",
                    "_rel_type": "cousin",
                    "source": "c_galois_css",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_galois_stabilizer_galois_into_galois_125",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_galois_stabilizer_qudit_stabilizer__112",
                    "_rel_type": "cousin",
                    "source": "c_galois_stabilizer",
                    "target": "c_qudit_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_skew-cyclic_galois_css_galois_css_126",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_skew-cyclic_galois_css_skew_cyclic__113",
                    "_rel_type": "cousin",
                    "source": "c_skew-cyclic_galois_css",
                    "target": "c_skew_cyclic"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_secret_sharing_galois_css_127",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_secret_sharing_approximate_qecc__114",
                    "_rel_type": "cousin",
                    "source": "c_quantum_secret_sharing",
                    "target": "c_approximate_qecc"
                }
            ...
            {
                "data": {
                    "id": "cousin_quantum_secret_sharing_galois_polynomial__115",
                    "_rel_type": "cousin",
                    "source": "c_quantum_secret_sharing",
            ...
            {
                "data": {
                    "id": "cousin_quantum_secret_sharing_reed_solomon__116",
                    "_rel_type": "cousin",
                    "source": "c_quantum_secret_sharing",
                    "target": "c_reed_solomon"
                }
            ...
            {
                "data": {
                    "id": "kingdomtodomain_galois_into_galois_quantum_domain_8",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_galois_into_galois_qecc_finite_128",
                    "_rel_type": "parent",
                    "source": "c_galois_into_galois",
                    "target": "c_qecc_finite"
                }
            ...
            {
                "data": {
                    "id": "cousin_galois_into_galois_qudits_into_qudits__117",
                    "_rel_type": "cousin",
                    "source": "c_galois_into_galois",
            ...
            {
                "data": {
                    "id": "parent_galois_true_stabilizer_galois_stabilizer_129",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_galois_true_stabilizer_q-ary_linear__118",
                    "_rel_type": "cousin",
                    "source": "c_galois_true_stabilizer",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_group_gkp_group_quantum_130",
                    "_rel_type": "parent",
                    "source": "c_group_gkp",
                    "target": "c_group_quantum"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_gkp_oscillator_stabilizer__119",
                    "_rel_type": "cousin",
                    "source": "c_group_gkp",
                    "target": "c_oscillator_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_double_group_gkp_131",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_quantum_double_topological_132",
                    "_rel_type": "parent",
                    "source": "c_quantum_double",
                    "target": "c_topological"
                }
            ...
            {
                "data": {
                    "id": "cousin_quantum_double_qudit_surface__121",
                    "_rel_type": "cousin",
                    "source": "c_quantum_double",
            ...
            {
                "data": {
                    "id": "cousin_quantum_double_string_net__122",
                    "_rel_type": "cousin",
                    "source": "c_quantum_double",
                    "target": "c_string_net"
                }
            ...
            {
                "data": {
                    "id": "parent_group_quantum_qecc_133",
                    "_rel_type": "parent",
                    "source": "c_group_quantum",
                    "target": "c_qecc"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_quantum_qecc_finite__123",
                    "_rel_type": "cousin",
                    "source": "c_group_quantum",
                    "target": "c_qecc_finite"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_quantum_qudits_into_qudits__124",
                    "_rel_type": "cousin",
                    "source": "c_group_quantum",
                    "target": "c_qudits_into_qudits"
                }
            ...
            {
                "data": {
                    "id": "cousin_group_quantum_oscillators__125",
                    "_rel_type": "cousin",
                    "source": "c_group_quantum",
                    "target": "c_oscillators"
                }
            ...
            {
                "data": {
                    "id": "parent_molecular_group_gkp_134",
                    "_rel_type": "parent",
                    "source": "c_molecular",
                    "target": "c_group_gkp"
                }
            ...
            {
                "data": {
                    "id": "parent_rotor_gkp_group_gkp_135",
                    "_rel_type": "parent",
                    "source": "c_rotor_gkp",
                    "target": "c_group_gkp"
                }
            ...
            {
                "data": {
                    "id": "parent_frobenius_qudits_into_qudits_136",
                    "_rel_type": "parent",
                    "source": "c_frobenius",
                    "target": "c_qudits_into_qudits"
                }
            ...
            {
                "data": {
                    "id": "cousin_frobenius_quantum_cyclic__127",
                    "_rel_type": "cousin",
                    "source": "c_frobenius",
                    "target": "c_quantum_cyclic"
                }
            ...
            {
                "data": {
                    "id": "parent_qudit_hamming_css_qudit_css_137",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_qudit_hamming_css_quantum_hamming_css__128",
                    "_rel_type": "cousin",
                    "source": "c_qudit_hamming_css",
                    "target": "c_quantum_hamming_css"
                }
            ...
            {
                "data": {
                    "id": "parent_stab_3_1_2_qudit_css_138",
                    "_rel_type": "parent",
                    "source": "c_stab_3_1_2",
                    "target": "c_qudit_css"
                }
            ...
            {
                "data": {
                    "id": "parent_stab_3_1_2_holographic_139",
                    "_rel_type": "parent",
                    "source": "c_stab_3_1_2",
                    "target": "c_holographic"
                }
            ...
            {
                "data": {
                    "id": "cousin_stab_3_1_2_quantum_secret_sharing__129",
                    "_rel_type": "cousin",
                    "source": "c_stab_3_1_2",
            ...
            {
                "data": {
                    "id": "parent_qudit_css_qudit_stabilizer_140",
                    "_rel_type": "parent",
                    "source": "c_qudit_css",
                    "target": "c_qudit_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_qudit_css_q-ary_linear__131",
                    "_rel_type": "cousin",
                    "source": "c_qudit_css",
                    "target": "c_q-ary_linear"
                }
            ...
            {
                "data": {
                    "id": "parent_qudit_surface_qudit_css_141",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_qudit_surface_topological_abelian_142",
                    "_rel_type": "parent",
                    "source": "c_qudit_surface",
                    "target": "c_topological_abelian"
                }
            ...
            {
                "data": {
                    "id": "cousin_qudit_surface_surface__132",
                    "_rel_type": "cousin",
                    "source": "c_qudit_surface",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "cousin_qudit_surface_qudit_stabilizer__133",
                    "_rel_type": "cousin",
                    "source": "c_qudit_surface",
                    "target": "c_qudit_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_qudit_stabilizer_qudits_into_qudits_143",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_qudits_into_qudits_qecc_finite_144",
                    "_rel_type": "parent",
                    "source": "c_qudits_into_qudits",
                    "target": "c_qecc_finite"
                }
            ...
            {
                "data": {
                    "id": "parent_polynomial_qudit_css_145",
                    "_rel_type": "parent",
                    "source": "c_polynomial",
                    "target": "c_qudit_css"
                }
            ...
            {
                "data": {
                    "id": "cousin_polynomial_reed_solomon__134",
                    "_rel_type": "cousin",
                    "source": "c_polynomial",
                    "target": "c_reed_solomon"
                }
            ...
            {
                "data": {
                    "id": "cousin_polynomial_cyclic__135",
                    "_rel_type": "cousin",
                    "source": "c_polynomial",
                    "target": "c_cyclic"
                }
            ...
            {
                "data": {
                    "id": "cousin_polynomial_quantum_mds__136",
                    "_rel_type": "cousin",
                    "source": "c_polynomial",
                    "target": "c_quantum_mds"
                }
            ...
            {
                "data": {
                    "id": "parent_fusion_stabilizer_146",
                    "_rel_type": "parent",
                    "source": "c_fusion",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_concatenated_qecc_147",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_quantum_cyclic_qecc_148",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_cyclic_cyclic__139",
                    "_rel_type": "cousin",
                    "source": "c_quantum_cyclic",
                    "target": "c_cyclic"
                }
            ...
            {
                "data": {
                    "id": "parent_random_circuit_dynamic_gen_149",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_approximate_qecc_qecc_150",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_holographic_oaecc_151",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_fracton_hamiltonian_152",
                    "_rel_type": "parent",
                    "source": "c_fracton",
                    "target": "c_hamiltonian"
                }
            ...
            {
                "data": {
                    "id": "parent_hamiltonian_oecc_154",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_hamiltonian_qldpc__141",
                    "_rel_type": "cousin",
                    "source": "c_hamiltonian",
                    "target": "c_qldpc"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_mds_qecc_finite_155",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_mds_mds__142",
                    "_rel_type": "cousin",
                    "source": "c_quantum_mds",
                    "target": "c_mds"
                }
            ...
            {
                "data": {
                    "id": "cousin_quantum_mds_generalized_reed_solomon__143",
                    "_rel_type": "cousin",
                    "source": "c_quantum_mds",
                    "target": "c_generalized_reed_solomon"
                }
            ...
            {
                "data": {
                    "id": "parent_dynamic_gen_oecc_156",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_topological_hamiltonian_157",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_topological_abelian_topological_158",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_topological_abelian_qldpc_159",
                    "_rel_type": "parent",
                    "source": "c_topological_abelian",
                    "target": "c_qldpc"
                }
            ...
            {
                "data": {
                    "id": "cousin_topological_abelian_qudit_stabilizer__144",
                    "_rel_type": "cousin",
                    "source": "c_topological_abelian",
                    "target": "c_qudit_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_perfect_qecc_finite_160",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_xyz_product_stabilizer_161",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_xyz_product_generalized_homological_product_162",
                    "_rel_type": "parent",
                    "source": "c_xyz_product",
            ...
            {
                "data": {
                    "id": "cousin_xyz_product_hypergraph_product__146",
                    "_rel_type": "cousin",
                    "source": "c_xyz_product",
                    "target": "c_hypergraph_product"
                }
            ...
            {
                "data": {
                    "id": "cousin_generalized_homological_product_css__147",
                    "_rel_type": "cousin",
                    "source": "c_generalized_homological_product",
                    "target": "c_css"
                }
            ...
            {
                "data": {
                    "id": "parent_expander_lifted_product_lifted_product_164",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_expander_lifted_product_tanner__148",
                    "_rel_type": "cousin",
                    "source": "c_expander_lifted_product",
                    "target": "c_tanner"
                }
            ...
            {
                "data": {
                    "id": "parent_distance_balanced_css_165",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_distance_balanced_homological_product_166",
                    "_rel_type": "parent",
                    "source": "c_distance_balanced",
            ...
            {
                "data": {
                    "id": "cousin_distance_balanced_subsystem_stabilizer__149",
                    "_rel_type": "cousin",
                    "source": "c_distance_balanced",
                    "target": "c_subsystem_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "parent_homological_product_fiber_bundle_167",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_fiber_bundle_balanced_product_170",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_fiber_bundle_distance_balanced__150",
                    "_rel_type": "cousin",
                    "source": "c_fiber_bundle",
            ...
            {
                "data": {
                    "id": "parent_lifted_product_balanced_product_171",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_lifted_product_galois_css_172",
                    "_rel_type": "parent",
                    "source": "c_lifted_product",
                    "target": "c_galois_css"
                }
            ...
            {
                "data": {
                    "id": "cousin_lifted_product_surface__151",
                    "_rel_type": "cousin",
                    "source": "c_lifted_product",
                    "target": "c_surface"
                }
            ...
            {
                "data": {
                    "id": "cousin_lifted_product_haah_cubic__152",
                    "_rel_type": "cousin",
                    "source": "c_lifted_product",
                    "target": "c_haah_cubic"
                }
            ...
            {
                "data": {
                    "id": "parent_quantum_expander_hypergraph_product_173",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_quantum_expander_expander__153",
                    "_rel_type": "cousin",
                    "source": "c_quantum_expander",
                    "target": "c_expander"
                }
            ...
            {
                "data": {
                    "id": "parent_balanced_product_css_174",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_balanced_product_generalized_homological_product_175",
                    "_rel_type": "parent",
                    "source": "c_balanced_product",
                    "target": "c_generalized_homological_product"
                }
            ...
            {
                "data": {
                    "id": "cousin_balanced_product_subsystem_stabilizer__154",
                    "_rel_type": "cousin",
                    "source": "c_balanced_product",
                    "target": "c_subsystem_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_balanced_product_distance_balanced__155",
                    "_rel_type": "cousin",
                    "source": "c_balanced_product",
                    "target": "c_distance_balanced"
                }
            ...
            {
                "data": {
                    "id": "parent_ramanujan_tensor_product_distance_balanced_176",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "cousin_ramanujan_tensor_product_distance_balanced__156",
                    "_rel_type": "cousin",
                    "source": "c_ramanujan_tensor_product",
                    "target": "c_distance_balanced"
                }
            ...
            {
                "data": {
                    "id": "cousin_ramanujan_tensor_product_freedman_meyer_luo__157",
                    "_rel_type": "cousin",
                    "source": "c_ramanujan_tensor_product",
            ...
            {
                "data": {
                    "id": "cousin_qldpc_topological__159",
                    "_rel_type": "cousin",
                    "source": "c_qldpc",
                    "target": "c_topological"
                }
            ...
            {
                "data": {
                    "id": "cousin_qldpc_dynamic_gen__160",
                    "_rel_type": "cousin",
                    "source": "c_qldpc",
                    "target": "c_dynamic_gen"
                }
            ...
            {
                "data": {
                    "id": "kingdomtodomain_category_quantum_quantum_domain_11",
                    "_rel_type": "domain",
            ...
            {
                "data": {
                    "id": "parent_category_quantum_qecc_finite_178",
                    "_rel_type": "parent",
                    "source": "c_category_quantum",
                    "target": "c_qecc_finite"
                }
            ...
            {
                "data": {
                    "id": "parent_string_net_category_quantum_179",
                    "_rel_type": "parent",
                    "source": "c_string_net",
            ...
            {
                "data": {
                    "id": "parent_string_net_topological_180",
                    "_rel_type": "parent",
                    "source": "c_string_net",
                    "target": "c_topological"
                }
            ...
            {
                "data": {
                    "id": "parent_fibonacci_string_net_181",
                    "_rel_type": "parent",
                    "source": "c_fibonacci",
                    "target": "c_string_net"
                }
            ...
            {
                "data": {
                    "id": "parent_fermions_qecc_finite_182",
                    "_rel_type": "parent",
                    "source": "c_fermions",
                    "target": "c_qecc_finite"
                }
            ...
            {
                "data": {
                    "id": "cousin_fermions_qubits_into_qubits__161",
                    "_rel_type": "cousin",
                    "source": "c_fermions",
                    "target": "c_qubits_into_qubits"
                }
            ...
            {
                "data": {
                    "id": "cousin_fermions_oscillators__162",
                    "_rel_type": "cousin",
                    "source": "c_fermions",
                    "target": "c_oscillators"
                }
            ...
            {
                "data": {
                    "id": "parent_majorana_stab_fermions_183",
                    "_rel_type": "parent",
            ...
            {
                "data": {
                    "id": "parent_majorana_stab_stabilizer_184",
                    "_rel_type": "parent",
                    "source": "c_majorana_stab",
                    "target": "c_stabilizer"
                }
            ...
            {
                "data": {
                    "id": "cousin_majorana_stab_dual__163",
                    "_rel_type": "cousin",
                    "source": "c_majorana_stab",
                    "target": "c_dual"
                }
            ...
            {
                "data": {
                    "id": "cousin_majorana_stab_css__164",
                    "_rel_type": "cousin",
                    "source": "c_majorana_stab",
                    "target": "c_css"
                }
            ...
            {
                "data": {
                    "id": "cousin_majorana_stab_cyclic__165",
                    "_rel_type": "cousin",
                    "source": "c_majorana_stab",
                    "target": "c_cyclic"
                }
            ...
            {
                "data": {
                    "id": "cousin_majorana_stab_reed_muller__166",
                    "_rel_type": "cousin",
                    "source": "c_majorana_stab",
                    "target": "c_reed_muller"
                }
